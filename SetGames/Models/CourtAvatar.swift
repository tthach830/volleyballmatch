...
public struct CourtAvatar: Identifiable, Hashable {
    ...
    public static let availableAvatars: [CourtAvatar] = [
        ...
        CourtAvatar(id: "sand_dive", name: "Sand Dive", emoji: "sand_dive"),
        CourtAvatar(id: "wilson", name: "Wilson", emoji: "wilson"),
        CourtAvatar(id: "blue_whale", name: "Blue Whale", emoji: "blue_whale"),
        ...
        CourtAvatar(id: "lightning", name: "Lightning", emoji: "⚡️"),
        CourtAvatar(id: "crown", name: "Crown", emoji: "👑"),
        CourtAvatar(id: "wave", name: "Wave", emoji: "🌊"),
        CourtAvatar(id: "orca", name: "Orca", emoji: "🐋"),
        CourtAvatar(id: "fire", name: "Fire", emoji: "🔥"),
        CourtAvatar(id: "otter", name: "Otter", emoji: "🦦"),
        CourtAvatar(id: "eagle", name: "Eagle", emoji: "🦅"),
        CourtAvatar(id: "lion", name: "Lion", emoji: "🦁"),
